 ...
 * @author Strongest
 */
@WebServlet(name="AdminGameDetail", urlPatterns={"/agameDetails"})
public class AdminGameDetail extends HttpServlet {
...
//        request.setAttribute("devList", devList);
        request.getRequestDispatcher("AdminGameDetail.jsp").forward(request, response);
        gameList_full.clear();
    }
